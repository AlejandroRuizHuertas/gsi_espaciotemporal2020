...
public class Contagiado {
	...
	public static Vector<Contagiado> readAllByCity(String ciudad) {
		Vector<Contagiado> v = ContagiadoDAO.readAllByCity(ciudad);
		return v;
	}

	public static Vector<Contagiado> readAllByDate(String ciudad, String fecha) {
		Vector<Contagiado> v = ContagiadoDAO.readAllByDate(ciudad, fecha);
		return v;
	}
